...
public class DevicesFragment extends ListFragment {
    ...
    private void stopScan() {
        ...
        if(menu != null) {
           ...
           MenuItem menuItem1= menu.findItem(R.id.ble_scan_stop);
            if(menuItem1!=null){menuItem1.setVisible(false);}
        }
    ...
    public void onListItemClick(ListView l, View v, int position, long id) {
        ...
        Constants.currentDeviceSelectedAddress =device.getAddress();
